...
static void ewmh_update_wm_desktop_recursively(void* /*Con*/ con, const uint32_t desktop)
{
#if 0
    Con *child;
 ...
 *
 */
/*Con */ void* ewmh_get_workspace_by_index(uint32_t idx)
{
#if 0
 ...
 *
 */
uint32_t ewmh_get_workspace_index(void* /*Con*/ con)
{
#if 0
    uint32_t index = 0;
