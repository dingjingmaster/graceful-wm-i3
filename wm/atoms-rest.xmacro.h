...
#ifndef GRACEFUL_XF_WM_ATOMS_REST_XMACRO_H
#define GRACEFUL_XF_WM_ATOMS_REST_XMACRO_H

#define GRACEFUL_WM_REST_ATOMS_XMACRO \
...
#endif //GRACEFUL_XF_WM_ATOMS_REST_XMACRO_H
