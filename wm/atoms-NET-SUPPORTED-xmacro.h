...
#ifndef GRACEFUL_XF_WM_ATOMS_NET_SUPPORTED_XMACRO_H
#define GRACEFUL_XF_WM_ATOMS_NET_SUPPORTED_XMACRO_H

#define GRACEFUL_WM_NET_SUPPORTED_ATOMS_XMACRO \
...
#endif //GRACEFUL_XF_WM_ATOMS_NET_SUPPORTED_XMACRO_H
